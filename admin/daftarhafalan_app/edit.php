...
<div id="edit-hafalanbaru<?= $data['id'] ?>" class="modal" tabindex="-1" aria-hidden="true">
  ...
  <select id="status" name="status" class="form-select 
    <?= $data['status'] == 'Mengulang' ? 'text-red-600' : 'text-green-600' ?>">
    <option value="Mengulang" <?= $data['status'] == 'Mengulang' ? 'selected' : '' ?>>Mengulang</option>
    <option value="Tidak Mengulang" <?= $data['status'] == 'Tidak Mengulang' ? 'selected' : '' ?>>Tidak Mengulang</option>
  </select>
</div>
            </div>
